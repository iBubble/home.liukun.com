...
### 学生端
- **主页**：http://home.liukun.com/Projects/Exam/
- **考试列表**：http://home.liukun.com/Projects/Exam/exam_list.php
- **考试记录**：http://home.liukun.com/Projects/Exam/records.php
- **错题本**：http://home.liukun.com/Projects/Exam/wrong_questions.php

### 管理端
- **登录**：http://home.liukun.com/Projects/Exam/admin/login.php
- **后台首页**：http://home.liukun.com/Projects/Exam/admin/

### Samples页面
- **项目列表**：http://home.liukun.com/projects.html
...
```bash
# 访问学生登录页面
curl http://home.liukun.com/Projects/Exam/

# 访问管理员登录页面
curl http://home.liukun.com/Projects/Exam/admin/login.php
```
