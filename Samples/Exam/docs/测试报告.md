...
### 数据库配置文件
**文件**：`Samples/Exam/inc/db.inc.php`
...
### 学生端
- **主页**：http://home.liukun.com/Samples/Exam/
- **考试列表**：http://home.liukun.com/Samples/Exam/exam_list.php
- **考试记录**：http://home.liukun.com/Samples/Exam/records.php
- **错题本**：http://home.liukun.com/Samples/Exam/wrong_questions.php

### 管理端
- **登录**：http://home.liukun.com/Samples/Exam/admin/login.php
- **后台首页**：http://home.liukun.com/Samples/Exam/admin/

### Samples页面
- **项目列表**：http://home.liukun.com/samples.html
...
```bash
# 访问学生登录页面
curl http://home.liukun.com/Samples/Exam/

# 访问管理员登录页面
curl http://home.liukun.com/Samples/Exam/admin/login.php
```
